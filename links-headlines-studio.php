...
define('LHS_PLUGIN_VERSION', '0.0.1');
...
class LinksHeadlinesStudio
{
    ...
    public function ajax_save_settings()
    {
        ...
        // Basic settings
        $sanitized_settings['enable_link_styling'] = isset($settings['enable_link_styling']) ? true : false;
        $sanitized_settings['enable_headline_styling'] = isset($settings['enable_headline_styling']) ? true : false;
